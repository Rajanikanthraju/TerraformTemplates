...
variable "app1_cidr_range" {
    type = string
    description = "cidr range of app1 subnet"
  
}
variable "app2_cidr_range" {
    type = string
    description = "cidr range of app2 subnet"
}
...
variable "app1_az" {
    type = string
    description = "availability zone of app1 subnet"
  
}
variable "app2_az" {
    type = string
    description = "availability zone of app2 subnet"
